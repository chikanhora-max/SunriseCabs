...
export const metadata: Metadata = {
  ...
  description: "A premium Kandy car-rental and transportation showcase built around publicly verifiable Sunrise Cabs information.",
